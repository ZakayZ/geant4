...
def draw_particle_count():
    C12 = pd.read_csv(f'Results/{prefix}C12.csv')
    C13 = pd.read_csv(f'Results/{prefix}C13.csv')
    N12 = pd.read_csv(f'Results/{prefix}N12.csv')
    N13 = pd.read_csv(f'Results/{prefix}N13.csv')
...
def draw_momentum():
    stat_data = parse_momentum(f'Results/{prefix}stat.data')
    x_data = parse_momentum(f'Results/{prefix}mov_x.data')
    y_data = parse_momentum(f'Results/{prefix}mov_y.data')
    z_data = parse_momentum(f'Results/{prefix}mov_z.data')
